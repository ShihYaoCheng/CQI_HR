...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="D34CAFA9:7713:1353CF6:55C9BD48" name="octolytics-dimension-request_id" />
...
<meta content="sAG56VaGSGlOPE95gOVLUCyGXOVHFNkClWaLqkrzTgbJMdpx7S0X9AOrao9rl2+ogx4/rgHCPpkivwIlwUtUCg==" name="csrf-token" />
...
<div class="js-clone-url clone-url "
  ...
  <div class="clone-options">You can clone with
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="21a7e6cb7900645ead2eb2385acecdba649e1cb1" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="R4Slz7AdieGzPjrexGCeg5B454Vyzi/GQoHwAFaQgYWfNUUp59S0oIpnjaKsWA4d2Ia2yB74y4IU+BO+Jn6yjg==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="21a7e6cb7900645ead2eb2385acecdba649e1cb1" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="r6M7HRPEn9vRXm55kp4TmGf4YXGSJMQCJXOKxHabm3YxRP10l2cPHrhl488Z4pb8wfYgb4iNmTydDQbz6dPc6A==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/twbs/bootstrap/blob/ab412b2404d12a3c55d1c4b798bd42ef32e80fab/js/transition.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
...
<div class="file">
  ...
  <div class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC39" class="blob-code blob-code-inner js-file-line">    $(<span class="pl-v">this</span>).<span class="pl-c1">one</span>(<span class="pl-s"><span class="pl-pds">&#39;</span>bsTransitionEnd<span class="pl-pds">&#39;</span></span>, <span class="pl-k">function</span> () { called <span class="pl-k">=</span> <span class="pl-c1">true</span> })</td>
      </tr>
      <tr>
        <td id="L40" class="blob-num js-line-number" data-line-number="40"></td>
        <td id="LC40" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">var</span> <span class="pl-en">callback</span> <span class="pl-k">=</span> <span class="pl-k">function</span> () { <span class="pl-k">if</span> (<span class="pl-k">!</span>called) $($el).<span class="pl-c1">trigger</span>($.<span class="pl-c1">support</span>.<span class="pl-c1">transition</span>.<span class="pl-c1">end</span>) }</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC46" class="blob-code blob-code-inner js-file-line">    $.<span class="pl-c1">support</span>.<span class="pl-c1">transition</span> <span class="pl-k">=</span> <span class="pl-c1">transitionEnd</span>()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC48" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> (<span class="pl-k">!</span>$.<span class="pl-c1">support</span>.<span class="pl-c1">transition</span>) <span class="pl-k">return</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC50" class="blob-code blob-code-inner js-file-line">    $.<span class="pl-c1">event</span>.<span class="pl-c1">special</span>.<span class="pl-c1">bsTransitionEnd</span> <span class="pl-k">=</span> {</td>
      </tr>
      <tr>
        <td id="L51" class="blob-num js-line-number" data-line-number="51"></td>
        <td id="LC51" class="blob-code blob-code-inner js-file-line">      bindType<span class="pl-k">:</span> $.<span class="pl-c1">support</span>.<span class="pl-c1">transition</span>.<span class="pl-c1">end</span>,</td>
      </tr>
      <tr>
        <td id="L52" class="blob-num js-line-number" data-line-number="52"></td>
        <td id="LC52" class="blob-code blob-code-inner js-file-line">      delegateType<span class="pl-k">:</span> $.<span class="pl-c1">support</span>.<span class="pl-c1">transition</span>.<span class="pl-c1">end</span>,</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC54" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">if</span> ($(e.<span class="pl-c1">target</span>).<span class="pl-c1">is</span>(<span class="pl-v">this</span>)) <span class="pl-k">return</span> e.<span class="pl-c1">handleObj</span>.<span class="pl-c1">handler</span>.<span class="pl-c1">apply</span>(<span class="pl-v">this</span>, arguments)</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04278s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
