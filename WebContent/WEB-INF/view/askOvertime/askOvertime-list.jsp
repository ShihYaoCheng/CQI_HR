...
<body role="document">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="askForOvertimeForm" name="askForOvertimeForm">
						...
						<div id="edit">
							<div class="form-group">
					            ...
					            <div class="col-sm-12 checkbox">
					            	<div id="roleTypeDiv" style="float:left;">
						            	<select class="form-control" id="overtimeId" name="overtimeId" onchange="selectedLeaveId(this.options[this.options.selectedIndex].label)">
							...
							<div class="form-group">
					            <label for="recipient-name" class="control-label col-sm-12" id="spendTimeStr" name="spendTimeStr">天數/時數：</label>
					            <div class="col-sm-12">
							...
							<div class="form-group">
					            <label for="recipient-name" class="control-label col-sm-12">起始時間：</label>
					            <div class="col-sm-12">
						            <div class="form-group">
							...
							<div class="form-group">
					            <label for="recipient-name" class="control-label col-sm-12">結束時間：</label>
					            <div class="col-sm-12">
						            <div class="form-group">
				...
				<div class="modal-footer" style="margin-top:20px">
					...
					<button type="button" style="cursor:pointer;" class="btn btn-primary btn-lg " id="save" data-loading-text="儲存中" onclick="submit()">儲存</button>
				</div>
			</div>
		</div>
 	</div>
	...
	<script type="text/javascript">
		...
		function deleteData(id){
			var targetURL= "<c:url value='/security/askOvertime/"+id+"'/>";
